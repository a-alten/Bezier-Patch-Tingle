...
// Suggested positions for the lights. It is OK to change them if it fits in your scene better.w
// Especially, you may need to move them higher or lower!
VectorR3 myLightPositions[3] = {
    VectorR3(0.0, 15.0, -15.0),
    VectorR3(0.0, 15.0, 15.0),
    VectorR3(5.0, -2.0, -5.0),
};
...
void MySetupLights()
{
    ...
    myLights[1].DiffuseColor.Set(0.7, 0.7, 0.5);    // Yellow
...
void MySetupMaterials()
{
	...
	myMaterials[0].AmbientColor.Set(0.5f, 0.2f, 0.2f);
	myMaterials[0].DiffuseColor.Set(1.0f, 0.4f, 0.4f);
	myMaterials[0].SpecularColor.Set(0.8, 0.8, 0.8);
	myMaterials[0].SpecularExponent = 75.0;
	...
	myMaterials[2].AmbientColor.Set(0.5f, 0.2f, 0.2f);
	myMaterials[2].DiffuseColor.Set(1.0f, 0.4f, 0.4f);
	myMaterials[2].SpecularColor.Set(0.8, 0.8, 0.8);
	myMaterials[2].SpecularExponent = 75.0;
